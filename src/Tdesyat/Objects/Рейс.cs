...
namespace IIS.Tdesyat
{
    ...
    public class Рейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdesyat.DetailArrayOfИнфБронь fИнфБронь;
        ...
        public virtual IIS.Tdesyat.DetailArrayOfИнфБронь ИнфБронь
        {
            get
            {
                ...
                {
                    this.fИнфБронь = new IIS.Tdesyat.DetailArrayOfИнфБронь(this);
                }
                IIS.Tdesyat.DetailArrayOfИнфБронь result = this.fИнфБронь;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсE", typeof(IIS.Tdesyat.Рейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РейсL", typeof(IIS.Tdesyat.Рейс));
                }
            }
        }
    }
