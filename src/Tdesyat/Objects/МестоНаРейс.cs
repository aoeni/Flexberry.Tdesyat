...
namespace IIS.Tdesyat
{
    ...
    public class МестоНаРейс : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdesyat.КлассБилета fКласс;
        ...
        public virtual IIS.Tdesyat.КлассБилета Класс
        {
            get
            {
                ...
                IIS.Tdesyat.КлассБилета result = this.fКласс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсE", typeof(IIS.Tdesyat.МестоНаРейс));
                }
            }
            ...
            public static ICSSoft.STORMNET.View МестоНаРейсL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("МестоНаРейсL", typeof(IIS.Tdesyat.МестоНаРейс));
                }
            }
        }
    }
