...
namespace IIS.Tdesyat
{
    ...
    public class Пассажир : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Tdesyat.МестоНаРейс fМестоНаРейс;
        
        private IIS.Tdesyat.КодБрони fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "КодБрони"})]
        [NotNull()]
        public virtual IIS.Tdesyat.КодБрони КодБрони
        {
            get
            {
                ...
                IIS.Tdesyat.КодБрони result = this.fКодБрони;
        ...
        [PropertyStorage(new string[] {
                "МестоНаРейс"})]
        [NotNull()]
        public virtual IIS.Tdesyat.МестоНаРейс МестоНаРейс
        {
            get
            {
                ...
                IIS.Tdesyat.МестоНаРейс result = this.fМестоНаРейс;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПассажирE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирE", typeof(IIS.Tdesyat.Пассажир));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПассажирL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПассажирL", typeof(IIS.Tdesyat.Пассажир));
                }
            }
        }
    }
