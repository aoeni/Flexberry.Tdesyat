...
export let ValidationRules = {
  пассажир: {
    descriptionKey: 'models.i-i-s-tdesyat-инф-бронь.validations.пассажир.__caption__',
    validators: [
      validator('ds-error'),
  ...
  рейс: {
    descriptionKey: 'models.i-i-s-tdesyat-инф-бронь.validations.рейс.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ИнфБроньE', 'i-i-s-tdesyat-инф-бронь', {
