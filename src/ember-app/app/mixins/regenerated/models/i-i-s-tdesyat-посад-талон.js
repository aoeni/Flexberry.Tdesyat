...
export let ValidationRules = {
  датаВыд: {
    descriptionKey: 'models.i-i-s-tdesyat-посад-талон.validations.датаВыд.__caption__',
    validators: [
      validator('ds-error'),
      validator('date'),
    ],
  ...
  пассажир: {
    descriptionKey: 'models.i-i-s-tdesyat-посад-талон.validations.пассажир.__caption__',
    validators: [
      validator('ds-error'),
  ...
  рейс: {
    descriptionKey: 'models.i-i-s-tdesyat-посад-талон.validations.рейс.__caption__',
    validators: [
      validator('ds-error'),
      validator('presence', true),
    ],
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ПосадТалонE', 'i-i-s-tdesyat-посад-талон', {
  ...
  modelClass.defineProjection('ПосадТалонL', 'i-i-s-tdesyat-посад-талон', {
    датаВыд: attr('Дата выдачи', { index: 0 }),
