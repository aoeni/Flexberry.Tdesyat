...
moduleForAcceptance('[AGAT] Acceptance | i i s tdesyat посад талон l');

test('testing i-i-s-tdesyat-посад-талон-l', function(assert) {
  visit('/i-i-s-tdesyat-посад-талон-l');
