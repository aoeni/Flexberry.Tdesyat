...
moduleForAcceptance('[AGAT] Acceptance | i i s tdesyat место на рейс l');

test('testing i-i-s-tdesyat-место-на-рейс-l', function(assert) {
  visit('/i-i-s-tdesyat-место-на-рейс-l');
